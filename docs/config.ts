...
*/
import googleServiceJSON from "../android/app/google-services.json";
...
//replace with your Application token created from the Ethora server
...
const oauth_client = googleServiceJSON.client[0].oauth_client.find(
  (item) => item.client_type === 3
);
const googleAuthWebClientId = oauth_client?.client_id;
// TO BE DEPRECATED
